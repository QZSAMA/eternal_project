...
- 2026-09-09 求婚戒指改为内联 SVG 钻戒：银白戒圈、戒托、切面主钻与静态星光，保留渐显；取消整枚戒指循环旋转。无新增下载资源。

- 2026-09-09 求婚页改为左右分区：男主位于左侧，右侧独立排列戒指、三段文案与按钮，避免遮挡脸部。布局 smoke 对人物图片和交互区逐一断言无重叠；接受后的 `SHE SAID YES !!` 仍使用独立结尾页。
