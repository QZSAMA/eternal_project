...
> 当前版本：女生第一人称线性剧情；回忆自动照片泡泡 + “但是…”求婚句；小游戏为 Canvas 2D 雾子求治疗（X / 按钮请求治疗，紫球转黄球）。Three.js 已移除，所有运行时资源保持本地离线可用。
...
完整可编辑文案请见：[docs/story-script.md](docs/story-script.md)。它包含剧情台词、分支、照片字幕、开始页、小游戏、求婚和结尾界面文字。
...
3. 点击 / 空格 / 回车 推进剧情
4. 剧情中段有一个守望主题小游戏：桌面端用 WASD/鼠标，触屏端用虚拟摇杆和紫球/黄球/反向按钮；任何设备都可点"跳过"
...
| 触屏 | 点击推进 | 虚拟摇杆移动/瞄准；按住紫球或黄球发射；点“反向”让球回飞；也可点“跳过”继续主线 |
